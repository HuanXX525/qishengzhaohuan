...
#define WIND1(msg) COLOR1(msg,53,150,151,48)//风元素颜色
#define ROCK1(msg) COLOR1(msg,222,189,108,48)//岩元素颜色
#define WATER1(msg) COLOR1(msg,0,191,255,48)//水元素颜色
#define FIRE1(msg) COLOR1(msg,236,73,35,48)//火元素颜色
#define GRASS1(msg) COLOR1(msg,102,173,22,48)//草元素颜色
#define ICE1(msg) COLOR1(msg,70,130,180,48)//冰元素颜色
#define THUNDER1(msg) COLOR1(msg,148,93,196,48)//雷元素颜色
#define RED1(msg) COLOR1(msg,255,100,100,48) //HP
#define GREEN1(msg) COLOR1(msg,150,255,120,48)//
#define BLUE1(msg) COLOR1(msg,102,204,255,48)//
